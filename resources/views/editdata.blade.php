  ...
  <body>
    ...
    <form action="" method="POST">
        ...
        <div class="form-group" style="margin-left: 20px; margin-top:10px">
          ...
          <input type="text" class="form-control" id="namacategory" value="{{old('name', $listdata->name)}}" name="nama_category" style="width:250px">
        </div>
        <div class="form-group" style="margin-left: 20px; margin-top:10px">
            <label for="namacategory">Publish</label>
            <input type="text" class="form-control" id="namacategory" name="is_publish" value="{{old('is_publish' ,$listdata->is_publish)}}" style="width:250px">
          </div>
